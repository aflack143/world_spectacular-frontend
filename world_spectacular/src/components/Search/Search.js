...
const Search = (props) => {
    ...
    return (
        <div id='search'>
            <div>
                {/* <form>
                    <input type='text' name='search' placeholder="search" onChange={props.searchWorld} />
                    <input type='submit' value="Search" />
                </form> */}
                <button>Clear Search</button>
            </div>
            <div>
                {/* <button onclick={props.handleClickType} value='name'>By Name</button>
                <button>By Abbreviation</button> */}
                <fieldset className="search-input" onChange={props.searchWorld}>
                    <label for='name'><input type='search' name='name' placeholder='Search here' /></label>
                </fieldset>
